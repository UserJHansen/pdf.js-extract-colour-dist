...
export class AnnotationLayer {
     ...
     */
    static setDimensions(div: HTMLDivElement, { width, height, rotation }: PageViewport): void;
    static "__#21@#setAnnotationCanvasMap"(div: any, annotationCanvasMap: any): void;
}
